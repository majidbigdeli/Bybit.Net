...
namespace Bybit.Net.Interfaces.Clients.GeneralApi
{
    ...
    /// </summary>
    public interface IBybitRestClientGeneralApiTransfer
    {
        /// <summary>
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<CoinBalanceQuery>> GetAssetBalanceAsync(AccountType accountType, string asset, long? receiveWindow = null, CancellationToken ct = default);
    }
