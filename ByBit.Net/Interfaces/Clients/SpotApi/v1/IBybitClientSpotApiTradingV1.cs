...
namespace Bybit.Net.Interfaces.Clients.SpotApi.v1
{
    ...
    /// </summary>
    public interface IBybitClientSpotApiTradingV1
    {
        /// <summary>
        /// Place a new order
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<BybitSpotUserTradeV1>>> GetUserTradesAsync(string? symbol = null, DateTime? startTime = null, DateTime? endTime = null, long? fromId = null, long? toId = null, int? limit = null, long? receiveWindow = null, CancellationToken ct = default);
