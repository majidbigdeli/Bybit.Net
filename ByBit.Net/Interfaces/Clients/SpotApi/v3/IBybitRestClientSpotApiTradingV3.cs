...
namespace Bybit.Net.Interfaces.Clients.SpotApi.v3
{
    ...
    /// </summary>
    public interface IBybitRestClientSpotApiTradingV3
    {
        /// <summary>
        /// Place a new order
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<BybitSpotUserTradeWrapper>> GetUserTradesAsync(string? symbol = null, string orderId = null, long? fromId = null, long? toId = null, int? limit = null, long? receiveWindow = null, CancellationToken ct = default);
