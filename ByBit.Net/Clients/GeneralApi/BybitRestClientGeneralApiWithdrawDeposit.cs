...
{
    /// <inheritdoc />
    public class BybitRestClientGeneralApiWithdrawDeposit : IBybitRestClientGeneralApiWithdrawDeposit
    {
        private readonly BybitRestClientGeneralApi _baseClient;

        internal BybitRestClientGeneralApiWithdrawDeposit(BybitRestClientGeneralApi baseClient)
        {
