...
namespace Bybit.Net.Clients.SpotApi.v3
{
    ...
    internal class BybitRestClientSpotApiTradingV3 : IBybitRestClientSpotApiTradingV3
    {
        ...
        internal BybitRestClientSpotApiTradingV3(BybitRestClientBaseSpotApi baseClient)
        {
        ...
        /// <inheritdoc />
        public async Task<WebCallResult<BybitSpotOrderWrapper>> GetOrdersAsync(string? symbol = null, long? orderId = null, DateTime? startTime = null, DateTime? endTime = null, int? limit = null,  long? receiveWindow = null, CancellationToken ct = default)
        {
            var parameters = new Dictionary<string, object>();
        ...
        /// <inheritdoc />
        public async Task<WebCallResult<BybitSpotUserTradeWrapper>> GetUserTradesAsync(string? symbol = null, string orderId = null, long? fromId = null, long? toId = null, int? limit = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            var parameters = new Dictionary<string, object>();
            parameters.AddOptionalParameter("symbol", symbol);
            parameters.AddOptionalParameter("orderId", orderId);
            ...
            return await _baseClient.SendRequestAsync<BybitSpotUserTradeWrapper>(_baseClient.GetUrl("spot/v3/private/my-trades"), HttpMethod.Get, ct, parameters, true).ConfigureAwait(false);
        }
