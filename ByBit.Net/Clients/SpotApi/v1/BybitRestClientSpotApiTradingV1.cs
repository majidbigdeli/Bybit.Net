...
{
    /// <inheritdoc />
    public class BybitRestClientSpotApiTradingV1 : IBybitRestClientSpotApiTradingV1
    {
        private readonly BybitRestClientBaseSpotApi _baseClient;

        internal BybitRestClientSpotApiTradingV1(BybitRestClientBaseSpotApi baseClient)
        {
        ...
        /// <inheritdoc />
        public async Task<WebCallResult<IEnumerable<BybitSpotUserTradeV1>>> GetUserTradesAsync(string? symbol = null, DateTime? startTime = null, DateTime? endTime = null, long? fromId = null, long? toId = null, int? limit = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            var parameters = new Dictionary<string, object>();
